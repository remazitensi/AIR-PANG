...
const AirChart = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // URL 파라미터에서 location과 subLocation 가져오기
        const params = new URLSearchParams(window.location.search);
        const locationName = params.get("location") || DEFAULT_LOCATION;
        const subLocationName = params.get("subLocation") || DEFAULT_SUBLOCATION;
